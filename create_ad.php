        ...
        <div class="col-md-6 mx-auto">
            ...
            <form action="backend/create_ad_process.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control overflow-auto" style="resize:none;" id="adDescription" name="adDescription" rows="4" required></textarea>
                </div>
                ...
                <div class="mb-3" id="petBrandSection" style="display: none;">
                    ...
                    <select class="form-select" id="petBrand" name="petBrand" required>
                ...
                <div class="mb-3" id="electronicTypeSection" style="display: none;">
                    ...
                    <select class="form-select" id="electronicType" name="electronicType" required>
                        <option style="display:none">Izvēlies</option>
                ...
                <div class="mb-3" id="electronicBrandSection" style="display: none;">
                    ...
                    <select class="form-select" id="electronicBrand" name="electronicBrand" required>
                ...
                <div class="mb-3" id="JobBrandSection" style="display: none;">
                    ...
                    <select class="form-select" id="JobBrand" name="JobBrand" required>
                        <option style="display:none">Izvēlies</option>
                    </select>
                </div>
                ...
                <div class="mb-3" id="FurnitureBrandSection" style="display: none;">
                    ...
                    <select class="form-select" id="FurnitureBrand" name="FurnitureBrand" required>
                        <option style="display:none">Izvēlies</option>
                    </select>
                </div>
                ...
                <div class="mb-3" id="otherTypeSection" style="display: none;">
                    ...
                    <input class="form-control" id="otherBrand" name="othersBrand"></input required>
                </div>

                <div class="mb-3">
                    <label for="adImages" class="form-label">Bildes</label>
                    <input type="file" class="form-control" id="adImages" name="adImages[]" multiple accept="image/*" required>
                </div>
