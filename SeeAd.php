...
<div class="container-fluid mt-4" style="min-height: 100vh; margin-bottom: 80px;">
                ...
                if (isset($_GET['adId'])) {
                    ...
                    try {
                        ...
                        if ($mainRow) {
                            echo '<div class="mb-3">';
                            ?>
                            <div class="row d-sm-flex d-block mx-auto justify-content-center">
                                <?php
                                if (isset($_GET['adId'])) {
                                    $adId = $_GET['adId'];
                                    ...
                                    try {
                                        ...
                                        foreach ($displayedImages as $index => $image) {
                                            echo '<div class="col-6 col-sm-3 d-flex justify-content-center p-2 p-sm-0 mx-sm-1 mx-auto">';
                                            echo '<a class="d-flex justify-content-center align-items-center w-100" href="#" data-bs-toggle="modal" data-bs-target="#imageModal">';
                                            echo '<img src="/AdImages/' . $image['image_path'] . '" class="img-fluid" style="max-width: 100%; height: auto;" alt="Ad Image">';
                                            echo '</a>';
                                            echo '</div>';
                                        }
                                        ...
                                        foreach ($images as $index => $image) {
                                            ...
                                            echo '<img src="/AdImages/' . $image['image_path'] . '" class="d-block img-fluid" alt="Ad Image">';
                                            echo '</div>';
                                        }
                        ...
                        <div class="container-fluid mt-5">
                            ...
                            $testUser = $_SESSION['id'];
                            if($sellerId == $testUser){
                                echo '<button disabled class="btn btn-primary mb-2 w-100" data-bs-toggle="modal" data-bs-target="#messageModal"><strong>Rakstīt ziņu</strong></button><br>';
                            }else{
                        ...
                        <div class="overflow-auto" style="scrollbar-color: #0d6efd rgba(248,244,244,50); max-height: 600px">
                            ...
                            if ($comments) {
                                foreach ($comments as $comment) {
                                    ...
                                    $stmt->bindParam(':user_id', $comenteerId);
                                    $stmt->execute();
                                    ...
                                    if ($user) {
                                        ...
                                        echo '<img src="' . $imagePath .'" alt="User Image" id="profileImage" class="img-fluid" style="border-radius:50%">';
                                        echo '</div>';
                                        ...
                                        echo '<div class="comment d-flex flex-row" data-comment-id="' . $comment['comment_id'] . '">';
                                        echo '<a class="like-btn me-3" style="cursor:pointer; text-decoration:none;"><i class="fa-regular fa-thumbs-up text-primary me-1"></i><strong> ' . $comment['likes'] . '</strong></a>';
                                        echo '<a class="dislike-btn ms-3" style="cursor:pointer; text-decoration:none;"><i class="fa-regular fa-thumbs-down text-danger me-1"></i><strong> ' . $comment['dislikes'] . '</strong></a>';
                                        echo '</div>';
                                        echo '</div>';
                                        echo '<hr>';
                                        echo '</div>';
                            ...
                            <div class="text-start">
                                <div class="row d-flex">
                                    <div class="col-md-5 text-center">
                                        ...
                                        ?>
                                        <img src="<?php echo $imagePath; ?>" alt="User Image" id="profileImage" class="img-fluid mx-auto text-center mb-3">
                                    </div>
                                    <div class="col-md-6 p-4 d-block m-auto shadow">
                                        <div class="d-sm-flex flex-sm-row flex-column align-items-center mb-3">
                                            <img class="w-25" src="favico.png">
                                            <div class="ms-5 d-flex flex-column justify-content-center">
                                                <span class="text-center"><?php echo $sellerRow['name'] . ' ' . $sellerRow['lastname']  ?></span>
                                                <hr class="my-2">
                                                <?php
                                                    if (isset($mainRow['sellerId'])) {
                                                        $sellerId = $mainRow['sellerId'];
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4 border border-black border-top-0 border-start-0 border-end-0">
                                            <h4 class="m-0"><i class="fa-solid fa-square-phone text-black"></i></h4>
                                            <p class="mx-2 mb-0"><?php echo $sellerRow['phone'] ?></p>
                                        </div>
                                            <div class="d-flex flex-row align-items-center mb-0 border border-black border-top-0 border-start-0 border-end-0">
                                            <h4 class="m-0"><i class="fa-solid fa-square-envelope text-black"></i></h4>
                                            <p class="mx-2 mb-0"><?php echo $sellerRow['email'] ?></p>
                                        </div>
                                        <div class="d-block text-center w-100 mt-4">
                                            <?php
                                             if($_SESSION['id'] == $sellerId){

                                             }else{
                                                echo '<button class="btn btn-danger rounded-0" data-bs-toggle="modal" data-bs-target="#reportModal">Ziņot par lietotāju!</button>';
                                             }
                                                ...
                                                <div class="card border-0 shadow mt-4" id="card-ad">
                                                    <div class="card-body">
                                                        ...
                                                        if (!empty($otherAd['image_path'])) {
                                                            ?>
                                                            <img src="/AdImages/<?php echo $otherAd['image_path']; ?>" class="img-fluid"
                                                                alt="Ad Image">
                                                            <?php
                                                        }
                                                        ?>
    ...
    <script>
        $(document).ready(function() {
            $('.like-btn, .dislike-btn').one('click', function() {
                var commentDiv = $(this).closest('.comment');
                var commentId = commentDiv.data('comment-id');
                var isLike = $(this).hasClass('like-btn');
                var action = isLike ? 'like' : 'dislike';

                $.ajax({
                    url: 'backend/update_likes_dislikes.php',
                    type: 'POST',
                    data: {
                    ...
                    success: function(response) {
                        ...
                        if (data.success) {
                            if (isLike) {
                                commentDiv.find('.like-btn strong').text(data.likes);
                            } else {
                                commentDiv.find('.dislike-btn strong').text(data.dislikes);
                            }
                        }
                    }
                });
